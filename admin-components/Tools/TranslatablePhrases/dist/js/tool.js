...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        ...
        save: function save(locale, original, phrase) {
            ...
            if (self.phrases[original][locale] == phrase) return;
        ...
        changeLanguage: function changeLanguage(locale) {
            if (locale) this.$router.push({ name: 'admin-translatable-phrases', params: { selectedLocale: locale } });else this.$router.push({ name: 'admin-translatable-phrases' });
        }
    },
        ...
        [
          ...
          !_vm.loading
            ? [
                  ...
                  [
                    _c(
                      ...
                      [
                        ...
                        _c(
                          "tbody",
                          _vm._l(_vm.phrases, function(translations, original) {
                            return _c(
                              "tr",
                              {
                                key: original,
                ...
                _vm._v(" "),
                !Object.keys(_vm.phrases).length
                  ? _c(
                      "div",
                      {
                        staticClass:
