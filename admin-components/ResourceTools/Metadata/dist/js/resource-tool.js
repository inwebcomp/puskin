...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Metadata__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_Metadata___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__components_Metadata__);


App.booting(function (Vue, router) {
    Vue.component('metadata-tool', __WEBPACK_IMPORTED_MODULE_0__components_Metadata___default.a);
});
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-68e5611a", Component.options)
  } else {
    hotAPI.reload("data-v-68e5611a", Component.options)
  }
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_form_backend_validation__ = __webpack_require__(13);
...
var root = 'resource-tool/metadata';
    ...
    methods: {
        ...
        save: function save() {
            ...
            App.api.request({
                ...
                App.$emit('metadataUpdate', _this3.resourceId);

                _this3.validationErrors = new __WEBPACK_IMPORTED_MODULE_0_form_backend_validation__["Errors"]();
                ...
                if (status == 422) {
                    _this3.validationErrors = new __WEBPACK_IMPORTED_MODULE_0_form_backend_validation__["Errors"](data.errors);
                }

                if (status == 409) {
                    _this3.$toasted.show(_this3.__('Another user has updated metadata since this page was loaded. Please refresh the page and try again.'), { type: 'error' });
                }
            });
        }
    },
...
var Form = function () {
    ...
    _createClass(Form, [{
        ...
        value: function withOptions(options) {
            ...
            this.__http = options.http || windowAxios || __webpack_require__(19);
...
var _objects = __webpack_require__(16);
...
var _formData = __webpack_require__(17);
...
var _fieldNameValidation = __webpack_require__(18);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-68e5611a", module.exports)
  }
}
